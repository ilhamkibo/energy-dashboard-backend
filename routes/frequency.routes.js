...
const { getFrequencyData } = require("../controllers/index");

/**
 * @swagger
 * /freq:
 *   get:
 *     summary: Get Frequency data
 *     description: |
 *       Mengambil data frekuensi (Hz) dari tabel `power_meter` berdasarkan parameter tanggal:
 *
 *       **Mode:**
...
router.get("/kva", getFrequencyData);
